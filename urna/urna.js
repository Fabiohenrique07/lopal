function urna() {
    ...
    if (total > 0){
        ...
        alert(
            ...
            "Candidato A: " + candidato_a + " voto(s) - " + porcent_cand_a + "% do total\n" +
            "Candidato B: " + candidato_b + " voto(s) - " + porcent_cand_b + "% do total\n" +
            "Brancos: " + brancos + " voto(s) - " + porcent_brancos + "% do total\n" +
            "Nulos: " + nulos + " voto(s) - " + porcent_nulos  + "% do total"
        );
    }
}